...
# sbatch scripts/mfi/slurm_run_mfi.sh 0 --num_factors 3 --dtype float16 --batch_size 200000 --compile_model --autocast --cudnn_benchmark

# sbatch scripts/mfi/slurm_run_mfi.sh 0 --num_factors 4 --dtype float16 --batch_size 200000 --compile_model

# sbatch scripts/mfi/slurm_run_mfi.sh 0 --num_factors 5 --dtype float16 --batch_size 200000 --compile_model

sbatch scripts/mfi/slurm_run_mfi.sh 0 ../../outputs/networks/ --num_factors 3 --dtype float16 --batch_size 200000 --compile_model --autocast --cudnn_benchmark

sbatch scripts/mfi/slurm_run_mfi.sh 0 ../../outputs/networks/quantized/quant --num_factors 3 --dtype float16 --batch_size 200000 --compile_model --autocast --cudnn_benchmark

sbatch scripts/mfi/slurm_run_mfi.sh 0 ../../outputs/networks/quantized/int8 --num_factors 3 --dtype float16 --batch_size 200000 --compile_model --autocast --cudnn_benchmark
