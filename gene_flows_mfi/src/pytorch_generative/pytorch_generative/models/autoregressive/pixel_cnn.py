...
and above inputs (see src.pytorch_generative.pytorch_generative.nn.CausalConv2d for details).
...
from src.pytorch_generative.pytorch_generative import nn as pg_nn
from src.pytorch_generative.pytorch_generative.models import base
...
def reproduce(
    ...
    from src.pytorch_generative.pytorch_generative import datasets, models, trainer
